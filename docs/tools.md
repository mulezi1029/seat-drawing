...
| S 形图标  | Section 工具     | 绘制观众区域/区块，支持两种变体： • 矩形区域 (Rectangle) • 多边形区域 (Polygon) - 可通过多点绘制曲线边界 |
| 三个圆点横排 | 排座位工具 (Row)    | 绘制直线或弧形座位排                                                           |
| 九宫格圆点  | 交错排工具 (Block)  | 绘制交织的座位排（如剧院式前后交错排列）                                                 |
| 圆形     | 桌子工具 (Table)   | 绘制圆桌、矩形桌、马蹄形桌等                                                       |
| GA 矩形  | 区域工具 (Area/GA) | 绘制通用 Admission 区域，支持： • 矩形 • 圆形/椭圆形 • 多边形                            |
...
1. 双击进入 Section 内部编辑模式
2. 根据编辑模式动态过滤工具栏
3. 节点工具（编辑 Section 边界曲线）
